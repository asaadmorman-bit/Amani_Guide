      ...
      <main class="flex-1 p-6 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
          <section class="bg-gradient-to-br from-slate-900 to-slate-900/30 border border-slate-800/80 rounded-xl p-6 shadow-xl relative overflow-hidden">
            ...
            <div class="space-y-2">
              <span class="px-2 py-0.5 rounded text-[10px] font-mono font-bold tracking-wider bg-\${active.color}-500/10 text-\${active.color}-400 border border-\--\${active.color}-500/20 uppercase">\${active.role}</span>
          ...
          <section class="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-xl">
            ...
            <div class="bg-slate-950/50 p-4 border border-slate-800/60 rounded-xl flex items-center justify-between">
              ...
              <span class="px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-\${active.status === 'SYNCHRONIZED' ? 'emerald' : 'amber'}-500/10 text-\${active.status === 'SYNCHRONIZED' ? 'emerald' : 'amber'}-400 border border-\${active.status === 'SYNCHRONIZED' ? 'emerald' : 'amber'}-500/20">\${active.status}</span>
            </div>
          </section>
        </div>
